...
app.service('home',function(){
    ...
    $scope.doAdd=function($event){
        ...
        $http.post("http://localhost:8362/home/user/",data)
    ...
    $scope.doEdit=function(){
            $scope.isShow=true
            $http.get("http://localhost:8362/home/user/"+this.id).success(function(response) {
    ...
    $scope.delUser=function($event){
        $http.delete("http://localhost:8362/home/user/"+this.id)
        .success(function(response) {
    ...
    $scope.saveEdit=function(){
        ...
        $http.put("http://localhost:8362/home/user/"+this.id,newdata)
        .success(function(response) {
